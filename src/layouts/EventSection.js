...
export default function EventSection(props) {
  ...
  return (
    <div className={classes.section}>
      ...
      <div>
        <GridContainer style={{display:"flex", justifyContent: (length < 3) ? "center" : "flex-start"}}>
          {cards}
          ...
          <Card>
              <img
                ...
                className={classes.imgCardTop}
                src="http://da5.lodz.pl/wp-content/uploads/0001.jpg"
                alt="Card-img-cap"
              />
              <CardBody>
          ...
          <GridItem xs={12} sm={12} md={4}>
            <Card>
              <img
                style={{ height: "180px", width: "100%", display: "block", objectFit: "cover" }}
                className={classes.imgCardTop}
                src="http://da5.lodz.pl/wp-content/uploads/pielgrzymka-oda.jpg"
                alt="Card-img-cap"
              />
              <CardBody>
                <h4 className={classes.cardTitle}>Card title</h4>
          ...
          <GridItem xs={12} sm={12} md={4}>
            <Card>
              <img
                style={{ height: "180px", width: "100%", display: "block", objectFit: "cover" }}
                className={classes.imgCardTop}
                src="http://da5.lodz.pl/wp-content/uploads/Biblia-polska-promo-6.png"
                alt="Card-img-cap"
              />
              <CardBody>
                <h4 className={classes.cardTitle}>Card title</h4>
